# Este é o conteúdo COMPLETO de 'src/library_service.py'

from datetime import timedelta
from typing import List
from models import Emprestimo, Livro, Usuario

# A LINHA QUE CAUSAVA O IMPORT ERROR FOI REMOVIDA DAQUI
...
class LibraryService:
    ...
    def emprestar(self, emprestimo_id: str, usuario_id: str, isbn: str):
        ...
        ## Em src/library_service.py, dentro de def emprestar:

        if len(ativos) >= usuario.limite_emprestimos:
            raise LimiteEmprestimoExcedidoError("Limite de empréstimos atingido") # <--- PRONTO!
    ...
    def devolver(self, emprestimo_id: str):
        ...
        # Assumindo que seu modelo Emprestimo tem essa função
